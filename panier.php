    ...
    if (isset($_GET['action']) && $_GET['action'] == 'payer') {
        unset($_SESSION['panier']);
        $msg .= '<div class="alert alert-success">Merci pour votre commande, le paiement par chèque doit etre envoyé a l\'adresse : 1 rue du commerce 75000 Paris.</div>';
            ...
            <div class="col-12 mt-5">
                <table class="table table-bordered">
                    ...
                    if (empty($_SESSION['panier']['id_article'])) {
                        echo '<tr>';
                        echo ' <td colspan="4"><h4 class="text-center">Votre panier est vide</h4></td>';
                        echo '</tr>';
                    } else {
                        ...
                        if (user_is_connected()) {
                            ...
                            echo 'Veuillez vous <a href=" connexion.php">connecter</a> ou vous <a href="inscription.php">inscrire</a> afin de payer vote panier.';
                        }

                        echo '</td>';
                        echo '<td colspan="2"><a href="?action=vider" class="btn btn-danger">Vider le panier</a></td>';
                        echo '</tr>';
                    }
                    ?>
                </table>
